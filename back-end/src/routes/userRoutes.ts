...
router.get('/validate/token', authenticateMiddleware.authenticateToken, userController.validateToken);
router.put('/',authenticateMiddleware.authenticateToken, userController.editUser);
